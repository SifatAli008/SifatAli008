...
- **Admin dashboard**: Firebase Auth + content CRUD (dashboard UI still default shadcn dark)
...
Current featured URLs include hackathon wins, HackDay 2026, Category 3 workshop, and DevHub recruitment posts.
...
└── types/
public/assets/
├── images/                  # profile-image.jpeg, etc.
├── linkedin/                # optional post screenshots
└── pixel art/
scripts/seed.ts
firestore.rules
storage.rules
